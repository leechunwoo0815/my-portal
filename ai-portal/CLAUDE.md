...
| 2 | 内容审核工作流 | admin | 敏感词过滤 + 评论软隐藏 + 审计日志 | ✅ |
| 3 | 专栏付费订阅 | series | 付费内容 + 订单系统 | ⬜ |
| 4 | Markdown 导入/导出 | blog | 详情页导出 .md + 编辑器导入 .md | ✅ |
| 5 | 评论楼中楼 | comments | 知乎式扁平子线程 + @回复归属 + 收起/展开 | ✅ |
...
| 2 | 用户时间线 | user | 聚合所有行为 | ⬜ |
| 3 | 私信群聊 | message | 多人群聊 | ⬜ |
| 4 | 内容举报 | report | 用户举报 + 管理员审核 + 审计日志 | ✅ |
| 5 | 用户拉黑 | social | 拉黑后自动取消关注 + 状态查询 | ✅ |
